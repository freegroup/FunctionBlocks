...
import de.netallied.functionblock.modeleditor.fbt.network.figure.CompositeInputValueFigure;


public class CompositeInputValueModelEditPart extends AbstractGraphicalEditPart implements PropertyChangeListener, NodeEditPart
{
  /**
  ...
  public final void activate()
  {
    ...
    {
      super.activate();
      getCompositeInputValueModel().addPropertyChangeListener(this);
    }
  }
  ...
  public final void deactivate()
  {
    ...
    {
      super.deactivate();
      getCompositeInputValueModel().removePropertyChangeListener(this);
    }
  }
  ...
  protected CompositeInputValueModel getCompositeInputValueModel()
  {
    return (CompositeInputValueModel) getModel();
  }
  ...
  {
    return getNetworkModel().getSourceTransitions(getCompositeInputValueModel());
  }
  ...
  {
    return new CompositeInputValueFigure();
  }
  ...
  protected void refreshVisuals()
  {
    ...
    ValueTransitionModel obj =(ValueTransitionModel)getModelSourceConnections().get(0);

    EditPart part = getEditPart( this.getParent(), obj.getToObjectModel());
    
    CompositeInputValueFigure figure = (CompositeInputValueFigure)getFigure();
    ...
    figure.setText(getCompositeInputValueModel().getName());
