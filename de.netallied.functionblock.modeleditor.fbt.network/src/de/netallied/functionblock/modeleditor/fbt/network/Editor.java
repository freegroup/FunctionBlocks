...
import de.netallied.functionblock.modeleditor.fbt.network.editpart.ModelEditPartFactory;
 ...
 * 
 */
public class Editor extends  GraphicalEditorWithFlyoutPalette  implements PropertyChangeListener, IFunctionBlockEditorPart
{
  ...
  protected PaletteRoot getPaletteRoot()
  {
    if (palette == null)
    {
      IFbtEditorInput input = (IFbtEditorInput)getEditorInput();
	...
	protected void initializeGraphicalViewer()
  {
	...
	protected NetworkModel createContents()
	{
      ...
      return ((CompositeFunctionBlockModel)fileInput.getModel().getFunctionBlockModel()).getNetwork();
		}
		return null;
	}
