package de.netallied.functionblock.create.file.device;
...
class CreationPage extends WizardNewFileCreationPage 
{
  ...
  private static final String DEFAULT_EXTENSION = ".dev";
  ...
  {
    super("DeviceCreationPage", selection);
    page = wizard;
  ...
  public void createControl(Composite parent) 
  {
    ...
    setFileName("NewDevice" + NewWizard.fileCount + DEFAULT_EXTENSION);
  ...
  protected InputStream getInitialContents() 
  {
    try 
    {
      InputStream stream = Activator.getDefault().find(new Path("templates/functionblock/DeviceType.dev")).openStream();
