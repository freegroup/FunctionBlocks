 ...
 * 
 */
public class MoveInputValueCommand extends Command
{

	private int oldIndex;
  private int newIndex;
	private InputValueModel childColumn;
	private InputValueSegmentModel parentTable;

	public MoveInputValueCommand(InputValueModel child, InputValueSegmentModel parent, int oldIndex, int newIndex)
	{
