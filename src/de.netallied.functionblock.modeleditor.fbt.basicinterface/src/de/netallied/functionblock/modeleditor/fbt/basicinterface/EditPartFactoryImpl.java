...
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.DiagramEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.EventSegmentEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.FunctionBlockEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.FunctionBlockNameEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.FunctionBlockWaistEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.InputEventEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.InputEventSegmentEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.InputValueEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.InputValueSegmentEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.OutputEventEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.OutputEventSegmentEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.OutputValueEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.OutputValueSegmentEditPart;
import de.netallied.functionblock.modeleditor.fbt.basicinterface.editpart.ValueSegmentEditPart;
...
public class EditPartFactoryImpl implements EditPartFactory
{
    ...
    else if (model instanceof WithTransitionInModel)
      part = new WithTransitionInEditPart();
    else if (model instanceof WithTransitionOutModel)
      part = new WithTransitionOutEditPart();
