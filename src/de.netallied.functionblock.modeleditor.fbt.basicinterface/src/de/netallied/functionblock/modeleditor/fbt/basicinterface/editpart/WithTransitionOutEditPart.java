...
import de.netallied.functionblock.modeleditor.fbt.basicinterface.commands.DeleteWithTransitionOutCommand;
 ...
 * 
 */
public class WithTransitionOutEditPart extends AbstractConnectionEditPart implements PropertyChangeListener
{

  public WithTransitionOutEditPart()
  {
  }
  ...
  protected void createEditPolicies()
  {
    ...
    installEditPolicy(EditPolicy.CONNECTION_ROLE, new ConnectionEditPolicy()
    {
      ...
      {
        WithTransitionOutModel t = getWithTransitionModel();
        BasisFunctionBlockModel fb= (BasisFunctionBlockModel)t.getFromObjectModel().getAbstractFunctionBlockModel();
        return new DeleteWithTransitionOutCommand(fb,t);
       
      }
    });
  }

  public WithTransitionOutModel getWithTransitionModel()
  {
    return (WithTransitionOutModel)getModel();
  }
