 ...
 * Schema.
 * $Id: SubAppEventInputs.java,v 1.3 2007/02/14 19:23:03 freegroup Exp $
 */
...
/**
 * Class SubAppEventInputs.
 * 
 * @version $Revision: 1.3 $ $Date: 2007/02/14 19:23:03 $
 */
public class SubAppEventInputs implements java.io.Serializable {
    ...
    public SubAppEventInputs() {
        super();
        _subAppEventList = new Vector();
    } //-- de.netallied.functionblock.model.castor.SubAppEventInputs()
    ...
    /**
     * Method unmarshalSubAppEventInputs
     * 
     * 
     * 
     * @param reader
     * @return Object
     */
    public static java.lang.Object unmarshalSubAppEventInputs(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.netallied.functionblock.model.castor.SubAppEventInputs) Unmarshaller.unmarshal(de.netallied.functionblock.model.castor.SubAppEventInputs.class, reader);
    } //-- java.lang.Object unmarshalSubAppEventInputs(java.io.Reader) 
