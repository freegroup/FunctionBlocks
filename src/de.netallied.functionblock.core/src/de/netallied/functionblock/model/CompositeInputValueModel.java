 ...
 *
 */
public class CompositeInputValueModel extends AbstractInterfaceModel implements AbstractSourceModel
{
  private final InputValueModel input;

  public CompositeInputValueModel(InputValueModel input)
  {
     this.input = input;
  }
