...
class CreationPage extends WizardNewFileCreationPage 
{
  ...
  public void createControl(Composite parent) 
  {
    ...
    setFileName("NewBasicFBT" + NewWizard.fileCount + DEFAULT_EXTENSION);
  ...
  protected InputStream getInitialContents() 
  {
    try 
    {
      InputStream stream = Activator.getDefault().find(new Path("templates/functionblock/Basic.fbt")).openStream();
