 ...
 * Schema.
 * $Id: SubAppTypeDescriptor.java,v 1.3 2007/02/14 19:23:09 freegroup Exp $
 */
...
/**
 * Class SubAppTypeDescriptor.
 * 
 * @version $Revision: 1.3 $ $Date: 2007/02/14 19:23:09 $
 */
public class SubAppTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public SubAppTypeDescriptor() {
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                SubAppType target = (SubAppType) object;
        ...
        desc.setValidator(fieldValidator);
        //-- _subAppInterfaceList
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.netallied.functionblock.model.castor.SubAppInterfaceList.class, "_subAppInterfaceList", "SubAppInterfaceList", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SubAppType target = (SubAppType) object;
                return target.getSubAppInterfaceList();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SubAppType target = (SubAppType) object;
                    target.setSubAppInterfaceList( (de.netallied.functionblock.model.castor.SubAppInterfaceList) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new de.netallied.functionblock.model.castor.SubAppInterfaceList();
            }
        } );
        desc.setHandler(handler);
        desc.setRequired(true);
        ...
        //-- validation code for: _subAppInterfaceList
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        fieldValidator.setMinOccurs(1);
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
        //-- _subAppNetwork
        desc = new org.exolab.castor.xml.util.XMLFieldDescriptorImpl(de.netallied.functionblock.model.castor.SubAppNetwork.class, "_subAppNetwork", "SubAppNetwork", org.exolab.castor.xml.NodeType.Element);
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            public java.lang.Object getValue( java.lang.Object object ) 
                throws IllegalStateException
            {
                SubAppType target = (SubAppType) object;
                return target.getSubAppNetwork();
            }
            public void setValue( java.lang.Object object, java.lang.Object value) 
                throws IllegalStateException, IllegalArgumentException
            {
                try {
                    SubAppType target = (SubAppType) object;
                    target.setSubAppNetwork( (de.netallied.functionblock.model.castor.SubAppNetwork) value);
                }
                catch (java.lang.Exception ex) {
                    throw new IllegalStateException(ex.toString());
                }
            ...
            public java.lang.Object newInstance( java.lang.Object parent ) {
                return new de.netallied.functionblock.model.castor.SubAppNetwork();
            }
        } );
        desc.setHandler(handler);
        desc.setMultivalued(false);
        ...
        //-- validation code for: _subAppNetwork
        fieldValidator = new org.exolab.castor.xml.FieldValidator();
        { //-- local scope
        }
        desc.setValidator(fieldValidator);
    } //-- de.netallied.functionblock.model.castor.SubAppTypeDescriptor()
    ...
    {
        return de.netallied.functionblock.model.castor.SubAppType.class;
