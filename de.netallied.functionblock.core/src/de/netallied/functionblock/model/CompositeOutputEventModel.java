 ...
 *
 */
public class CompositeOutputEventModel extends AbstractInterfaceModel implements AbstractTargetModel
{
  private final OutputEventModel output;

  public CompositeOutputEventModel(OutputEventModel output)
  {
     this.output = output;
  }
