package de.netallied.functionblock.create.file.system;
...
class CreationPage extends WizardNewFileCreationPage 
{
  ...
  private static final String DEFAULT_EXTENSION = ".sys";
  ...
  {
    super("SystemCreationPage", selection);
    page = wizard;
  ...
  public void createControl(Composite parent) 
  {
    ...
    setFileName("NewSystem" + NewWizard.fileCount + DEFAULT_EXTENSION);
  ...
  protected InputStream getInitialContents() 
  {
    try 
    {
      InputStream stream = Activator.getDefault().find(new Path("templates/functionblock/System.sys")).openStream();
