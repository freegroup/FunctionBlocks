...
import de.netallied.functionblock.modeleditor.res.network.editpolicies.InputValueNodeEditPolicy;
import de.netallied.functionblock.modeleditor.res.network.figures.InputValueFigure;
...
public class InputValueModelEditPart extends InterfaceModelEditPart
{
  ...
  public InstanceInputValueModel getInstanceInputValueModel()
  {
    return (InstanceInputValueModel) getModel();
  }

  @Override
	protected List getModelTargetConnections() 
  {
 		return getNetworkModel().getTargetTransitions(getInstanceInputValueModel());
	}
