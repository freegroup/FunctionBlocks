...
class CreationPage extends WizardNewFileCreationPage 
{
  ...
  private static final String DEFAULT_EXTENSION = ".fbt";
  ...
  {
    super("FBTCreationPage", selection);
    page = wizard;
  ...
  public void createControl(Composite parent) 
  {
    ...
    setFileName("NewCompositeFBT" + NewWizard.fileCount + DEFAULT_EXTENSION);
  ...
  protected InputStream getInitialContents() 
  {
    try 
    {
      InputStream stream = Activator.getDefault().find(new Path("templates/functionblock/Composite.fbt")).openStream();
