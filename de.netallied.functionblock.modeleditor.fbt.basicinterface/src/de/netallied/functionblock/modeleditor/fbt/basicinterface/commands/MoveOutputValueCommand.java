 ...
 * 
 */
public class MoveOutputValueCommand extends Command
{

	private int oldIndex;
  private int newIndex;
	private OutputValueModel childColumn;
	private OutputValueSegmentModel parentTable;

	public MoveOutputValueCommand(OutputValueModel child, OutputValueSegmentModel parent, int oldIndex, int newIndex)
	{
