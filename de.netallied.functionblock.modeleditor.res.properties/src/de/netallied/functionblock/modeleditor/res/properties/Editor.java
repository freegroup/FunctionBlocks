 ...
 */
package de.netallied.functionblock.modeleditor.res.properties;
 ...
 * Comments
 */
public class Editor extends EditorPart implements IResourceEditorPart
{
  ...
  public void createPartControl(Composite parent)
  {
    ...
    standardText.setText(getAbstractFunctionBlockModel().getStandard());
    standardText.addModifyListener(new ModifyListener()
    {
      public void modifyText(ModifyEvent e)
      {
        String c = standardText.getText();
        if(!getAbstractFunctionBlockModel().getStandard().equals(c))
        {
          getAbstractFunctionBlockModel().setStandard(c);
          setDirty();
        }
      }
    });
  ...
  public ResourceTypeModel getAbstractFunctionBlockModel()
  {
     return ((IResEditorInput)getEditorInput()).getModel();
  }
}